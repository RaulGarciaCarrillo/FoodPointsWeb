        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Comparte</h3>
              <p class="text-muted">Comparte tus experiencias en Facebook</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Conoce</h3>
              <p class="text-muted">Descubre nuevos puestos de comida</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Comentarios</h3>
              <p class="text-muted">Comparte tu opinión con los demás</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Favoritos</h3>
              <p class="text-muted">Añade tus puestos como favoritos</p>
            </div>
          </div>
        </div>
      </div>
